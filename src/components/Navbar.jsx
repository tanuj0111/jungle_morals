...
import Sun from "../assets/SVG/Asset 11.svg";
import junglemorals from "../assets/SVG/Asset 1.svg";

import Sunlight from "../assets/SVG/Asset 12.svg";
import cloud1 from "../assets/SVG/Asset 13.svg";
import cloud2 from "../assets/SVG/Asset 14.svg";
import cloud3 from "../assets/SVG/Asset 15.svg";
import cloud4 from "../assets/SVG/Asset 16.svg";
import cloud5 from "../assets/SVG/Asset 17.svg";
import backgroundimg from "../assets/SVG/backgroundAsset7.svg";
          ...
          >
            <div className={`position-absolute z-3 ${styles.homeCloudOuter}`}>
              <div className={`position-relative ${styles.homeCloud}`}>
                <img src={cloud4} alt="cloud" className="position-absolute w-200 h-200 object-fit-contain" />
            ...
            <div className={`position-absolute  z-3 ${styles.theWhyCloudOuter}`}>
              <div className={`position-relative ${styles.theWhyCloud}`}>
                <img src={cloud2} alt="cloud" className="position-absolute w-200 h-200 object-fit-contain" />
                <div className="position-absolute w-100 h-100 d-flex align-items-center justify-content-center">
            ...
            <div className={`position-absolute  z-2 ${styles.whatCloudOuter}`}>
              <div className={`position-relative ${styles.whatCloud}`}>
                <img src={cloud1} alt="cloud" className="position-absolute w-200 h-200 object-fit-contain" />
                <div className="position-absolute w-100 h-100 d-flex align-items-center justify-content-center">
            ...
            <div className={`position-absolute  z-2 ${styles.charactersCloudOuter}`}>
              <div className={`position-relative ${styles.charactersCloud}`}>
                <img src={cloud3} alt="cloud" className="position-absolute w-200 h-200 object-fit-contain" />
                <div className="position-absolute w-100 h-100 d-flex align-items-center justify-content-center">
